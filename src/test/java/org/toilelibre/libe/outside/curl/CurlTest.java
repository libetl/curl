...
public class CurlTest {
    ...
    public void curlToRedirectionWithoutFollowRedirectParam () {
        this.assertFound (this.curl ("-k --cert-type PEM --cert src/test/resources/clients/libe/libe.pem:mylibepass https://localhost:%d/public/redirection"));
    }

    @Test
    public void curlToUnauthorized () {
        this.assertUnauthorized (this.curl ("-k --cert src/test/resources/clients/libe/libe.pem:mylibepass https://localhost:%d/public/unauthorized"));
    }

    @Test
    public void curlToRedirectionWithFollowRedirectParam () {
        this.assertOk (this.curl ("-k --cert src/test/resources/clients/libe/libe.pem:mylibepass -L https://localhost:%d/public/redirection"));
    }

    @Test
    public void curlWithHeaders () {
        this.assertOk (this.curl ("-k --cert src/test/resources/clients/libe/libe.pem:mylibepass -H'Host: localhost' -H'Authorization: 45e03eb2-8954-40a3-8068-c926f0461182' https://localhost:%d/public/v1/coverage/sncf/journeys?from=admin:7444extern"));
    }

    @Test
    public void readCurlPublicRoot () {
        this.assertOk (this.curl (this.$ ("-k --cert src/test/resources/clients/libe/libe.pem:mylibepass https://localhost:%d/public/")));
    }

    @Test
    public void readCurlWithHeaders () {
        this.assertOk (this.curl (this.$ ("-k --cert src/test/resources/clients/libe/libe.pem:mylibepass -H'Host: localhost' -H'Authorization: 45e03eb2-8954-40a3-8068-c926f0461182' https://localhost:%d/public/v1/coverage/sncf/journeys?from=admin:7444extern")));
    }

    @Test
    public void curlOfReadCurlOfReadCurl () {
        this.assertOk (this.curl (this.$ (this.$ (this.$ (this.$ ("-k --cert src/test/resources/clients/libe/libe.pem:mylibepass https://localhost:%d/public/"))))));
    }

    @Test
    public void readCurlCommand () {
        this.assertOk (this.curl ("-k --cert src/test/resources/clients/libe/libe.pem:mylibepass -X GET -H 'User-Agent: curl/7.49.1' -H 'Accept: */*' -H 'Host: localhost'  'https://localhost:%d/public/curlCommand1?param1=value1&param2=value2'"));
    }

    @Test
    public void readCurlOfCurlCommand () {
        this.assertOk (this.curl (this.$ ("-k --cert src/test/resources/clients/libe/libe.pem:mylibepass -X GET -H 'User-Agent: curl/7.49.1' -H 'Accept: */*' -H 'Host: localhost'  'https://localhost:%d/public/curlCommand2?param1=value1&param2=value2'")));
    }

    @Test
    public void tryToLoginAnonymouslyWithCurlCommand () {
        this.assertUnauthorized (this.curl ("-k --cert src/test/resources/clients/libe/libe.pem:mylibepass -X GET -H 'User-Agent: curl/7.49.1' -H 'Accept: */*' -H 'Host: localhost'  'https://localhost:%d/private/login'"));
    }

    @Test
    public void loginWithIncorrectLoginCurlCommand () {
        this.assertUnauthorized (this.curl ("-k --cert src/test/resources/clients/libe/libe.pem:mylibepass -X GET -H 'User-Agent: curl/7.49.1' -H 'Accept: */*' -H 'Host: localhost' -u foo:bar 'https://localhost:%d/private/login'"));
    }

    @Test
    public void loginCorrectLoginCurlCommand () {
        this.assertOk (this.curl ("-k --cert src/test/resources/clients/libe/libe.pem:mylibepass -L -X GET -H 'User-Agent: curl/7.49.1' -H 'Accept: */*' -H 'Host: localhost' -u user:password 'https://localhost:%d/private/login'"));
    }

    @Test
    public void withJsonBody () {
        this.assertOk (this.curl ("-k --cert src/test/resources/clients/libe/libe.pem:mylibepass -X POST 'https://localhost:%d/public/json' -d '{\"var1\":\"val1\",\"var2\":\"val2\"}'"));
    }

    @Test
    public void withUserAgent () {
        this.assertOk (this.curl ("-k --cert-type P12 --cert src/test/resources/clients/libe/libe.p12:mylibepass -X GET -A 'toto' -H 'Accept: */*' -H 'Host: localhost'  'https://localhost:%d/public'"));
    }
