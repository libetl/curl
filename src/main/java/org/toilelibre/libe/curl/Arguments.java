...
final class Arguments {
    ...
    final static Pattern CHEAPER_ARGS_SPLIT_REGEX = Pattern.compile("(\"[^\"]*\"|'[^']*'|\\S+)");
    ...
    final static Option  GET                      = Arguments.add (Option.builder ("G").longOpt ("get").desc ("forces to use GET request method").required (false).hasArg (false).build ());
