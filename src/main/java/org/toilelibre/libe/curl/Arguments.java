...
final class Arguments {
    ...
    final static Option  INTERCEPTOR      = Arguments.add (Option.builder ("interceptor").longOpt ("interceptor").desc ("interceptor classname. Must be a BiFunction<HttpRequest, Supplier<HttpResponse>, HttpResponse> or will be discarded").required (false).hasArg (true).build ());
